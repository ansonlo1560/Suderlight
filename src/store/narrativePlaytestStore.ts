// ============================================================
// Narrative QA / Playtest Store
// 用於比賽評審驗證敘事系統行為 — 不對一般玩家開放
// Activation: ?playtest | import.meta.env.DEV
// ============================================================
...
// ---- Store ----
export const useNarrativePlaytestStore = create<NarrativePlaytestState>((set) => ({
  active: false,
  ...
  pushLog: (entry) =>
    set((s) => ({
      eventLog: [
        ...
        ...s.eventLog.slice(0, 99), // cap at 100
      ],
    })),
