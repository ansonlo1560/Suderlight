...
export const renaClues: Record<RenaClueId, ClueDefinition> = {
  joke_book: {
    ...
    knowledge: 15,
    worldId: 'rena',
    locationId: 'comedy_club_backstage',
    pos: { x: 14, y: 10 },
    color: '#fff0d4',
    icon: '集',
    content: '蕾娜在每一場脫口秀前，都會把寫好的段子工整地抄進這本筆記裡。紙頁邊角有好幾處被暈開的墨跡——那不是水，是她在後台獨處時無聲滴落的眼淚。笑話越寫越多，模糊的字也越來越多，到後來，連她自己都分不清哪些是段子、哪些是求救。',
  ...
  dried_lipstick: {
    ...
    color: '#ff6b6b',
    icon: '妝',
    content: '這支口紅是她的第一件化妝品，父親送給她的登台禮物。那晚表演結束後，她回到休息室，發現自己再也笑不出來，卻在鏡子裡看見一張流淚的臉。於是她擰開口紅，對著鏡子畫了一個大大的、誇張的笑臉——把哭的那張臉，徹底遮住。口紅後來再也沒擰回去過，就那樣乾涸在「笑」的形狀裡。',
  ...
  obituary_clip: {
    ...
    color: '#d4d4d4',
    icon: '悼',
    content: '一張被折疊過無數次的訃告，邊角已經起了毛邊。日期正好是蕾娜首場脫口秀的那一天。訃告旁邊有一行鉛筆字：「爸，今晚的票我給你留了第一排。」字跡很用力，有些地方紙都快被戳破了。',
  ...
  show_poster: {
    ...
    knowledge: 10,
    worldId: 'rena',
    locationId: 'comedy_club_entrance',
    pos: { x: 20, y: 8 },
    color: '#ffe0a0',
    icon: '報',
    content: '俱樂部門口的演出海報，蕾娜的笑容燦爛得不像真人的。下方有一排小字：「全場笑聲保證——蕾娜，讓你的煩惱一掃而空！」海報已經貼了很久，邊角開始泛黃，但笑容依然鮮亮如新。不知道從什麼時候開始，海報上的日期再也沒有更換過。',
...
export const renaAftermath = {
  ...
  conclusion: '這是一場關於理解的練習。當一個人將自我價值完全綁定在「讓別人快樂」的責任上，她還敢不敢露出悲傷的表情？雖然遊戲中的週目可以重來，但現實中每一次允許對方「不笑也沒關係」，都是唯一且珍貴的。感謝你，沒有在她垮掉的時候伸手把她拉回舞台上。',
  paragraphs: {
    successDepth3: '你看見了鏡中的哭臉與口紅畫出的笑臉，你選擇了不修復，只是陪伴。她終於能對觀眾說出那個不好笑的故事。',
    successDepth2: '你聽見了那通電話的嘟聲、那句「你必須完成脫口秀」。你理解到她不是不想哭，而是被禁止哭。',
    successDepth1: '因為你選擇了傾聽而非強迫她「做自己」，她開始在鏡子前練習一種新的表情——不確定的，但不再孤獨。',
    failed: '你在最後一刻把「理解」變成了另一種表演要求。她的笑容更亮了，但眼神裡最後一絲光滅了。面具徹底長進了皮膚裡。',
    none: '她的故事尚未抵達結局。後台的鏡子還亮著，那張口紅笑臉依然在等待一個人——不是來修好它，而是來告訴它「現在不用再演了」。',
    innerDepth3: '你觸及了那面畫著笑臉的鏡子——她親手畫的偽裝，和你親眼看到的真相。她不再需要獨自面對。',
    innerDepth2: '你聽見了那通醫院打來的電話。她告訴你那是最後一個她能哭出來的時刻。從此之後，只剩下笑。',
    innerDepth1: '你只看見了她的掌聲和輝煌。她把你歸類為又一個來消費她笑容的人——這比沒來過更孤獨。',
  },
};
